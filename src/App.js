...
class App extends Component {
  ...
  openNewPage = chosenItem => {
    const url =
      chosenItem === "github"
        ? "https://github.com/EhabIbrahimH"
        : "https://www.linkedin.com/in/ehabibrahem/";
      ...
      <div>
        <div>
          <Jumbotron className="jumbotron-background">
            <h1 className="display-3" style={{ color: "white", zIndex: 0 }}>
              Excel Renderer
            </h1>
            <p className="lead" style={{ color: "white", zIndex: 0 }}>
              This is a part of Vodafone's internship Interview process
            </p>
            <Button
            ...
            <Button
              className="primary jumbotron-button"
              onClick={this.openNewPage.bind(this, "linkedin")}
            >
              LinkedIn
            </Button>
            <hr className="my-2" />
            <p style={{ color: "white", zIndex: 0 }}>
              Developed By Ehab Ibrahim
            </p>
          </Jumbotron>
        </div>
        <Container>
